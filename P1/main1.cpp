...
string Celebrate() // from ComputerSelectRPSLK()
{
  ...
  switch (randPick) {
  case 0:
    randCelebrate = "Woohoo nice job!";
    break;
  case 1:
    randCelebrate = "Great skill ;)";
    break;
  case 2:
    randCelebrate = "Amazing!";
    break;
  case 3:
    randCelebrate = "Nice job winner! Keep the streak";
    break;
  case 4:
    randCelebrate = "Superb Performance :)";
    break;
  default:
    cout << "Error in the function Celebrate. " << endl;
  }
